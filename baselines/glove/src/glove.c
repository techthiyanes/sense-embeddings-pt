...
real eta = 0.025; // Initial learning rate
real alpha = 0.75, x_max = 100.0; // 0.75 Weighting function parameters, not extremely sensitive to corpus, though may need adjustment for very small or very large corpora
real *W, *gradsq, *cost;
